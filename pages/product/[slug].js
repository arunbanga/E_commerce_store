        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src="https://rukminim1.flixcart.com/image/612/612/l2urv680/t-shirt/7/u/a/xl-hood-smart-black-smartees-original-image3nn2djgq8xv.jpeg?q=70"
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">
                Men Printed Hooded Neck Black T-Shirt
              </h1>
              ...
              <p className="leading-relaxed">
                ...
                sriracha taximy chia microdosing tilde DIY.Indxgo juiceramps
              ...
              {service && service != null && (
                <div className="text-green-700 text-sm mt-3">
                  Yah! The pincode is serviceable
                </div>
              )}
            </div>
          </div>
